...
<input type="text" value="${login.phone2 }" name="phone2" ><br>
<input type="text" value="${login.phone3 }" name="phone3" >
<br>
이메일<br><input type="text" value="${login.email1 }" name="email1" id="email1"><br>
       <input type="text" value="${login.email2 }" name="email2" id="email2" placeholder="직접입력"><br>
